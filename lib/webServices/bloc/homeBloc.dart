...
class HomeBloc{
  ...
  StreamSink<ApiResponse<HomePost>> get homePostSink=> _homePostController.sink;
  Stream<ApiResponse<HomePost>> get homePostStream =>_homePostController.stream;

  StreamController _singlePostController;
  StreamSink<ApiResponse<SinglePost>> get singlePostSink=>_singlePostController.sink;
  Stream<ApiResponse<SinglePost>> get singlePostStream=>_singlePostController.stream;

  StreamController _topicPostController;
  StreamSink<ApiResponse<TopicPost>> get topicPostSink=>_topicPostController.sink;
  Stream<ApiResponse<TopicPost>> get topicPostStream=> _topicPostController.stream;

  StreamController _subscribedPostController;
  StreamSink<ApiResponse<SubscribedPost>> get subscibedPostSink=>_subscribedPostController.sink;
  Stream<ApiResponse<SubscribedPost>> get subscribedPostStream=> _subscribedPostController.stream;

  StreamController _followedPostController;
  StreamSink<ApiResponse<AuthorFollowedPost>> get followedPostSink=>_followedPostController.sink;
  Stream<ApiResponse<AuthorFollowedPost>> get followedPostStream=> _followedPostController.stream;

  StreamController _favoritePostController;
  StreamSink<ApiResponse<FavoritesPost>> get favoritePostSink=>_favoritePostController.sink;
  Stream<ApiResponse<FavoritesPost>> get favoritePostStream=>_favoritePostController.stream;

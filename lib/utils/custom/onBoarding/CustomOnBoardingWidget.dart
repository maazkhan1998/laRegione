...
class CustomOnBoardingWidget extends StatefulWidget {
  ...
  CustomOnBoardingWidget({@required this.pages,@required this.selectedIndicatorColor,@required this.unSelectedIndicatorColor,@required this.skipWidget,@required this.doneWidget});

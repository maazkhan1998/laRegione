              ...
              child: Column(
                children: [
                  Expanded(
                    ...
                    separatorBuilder: (context,i)=>SizedBox(height:MySize.size10),
                    itemCount: 4,
...
class CustomListTile extends StatefulWidget {
  ...
  CustomListTile({@required this.image,@required this.comment,@required this.time});
  @override
      ...
      child:Row(
        ...
        children: [
          ...
          Expanded(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(widget.comment,maxLines: 2,overflow: TextOverflow.ellipsis,
                style: TextStyle(
